...
```
#####This graph gives more information about the corrolation of the cars and the mpg in city and highways. 
```{r}
ggplot(data = mpg, mapping = aes (x = cty,  fill = hwy)) + geom_bar(position = "dodge")
```
